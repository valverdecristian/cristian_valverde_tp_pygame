...
class Level2():
    def __init__(self,w,h):
        ...
        self.player = Player(x=100,y=400,speed_walk=6,speed_run=12,gravity=14,jump_power=30,frame_rate_ms=100,move_rate_ms=50,jump_height=140,p_scale=0.2,interval_time_jump=300)
    ...
    def update(self,lista_eventos):
        ...
        if not self.enemy_list and self.flagenemy == False:
            ...
            self.flagenemy = True
            llave = Objeto(x=1000, y=550, width=70, height=100, image_path="images/objetos/keyRed.png", nombre="llave")
