...
class Level3():
    def __init__(self,w,h):
        ...
        self.static_background = Background(x=0,y=0,width=w,height=h,path="images/locations/all3.png")
        ...
        self.enemy_list.append (Enemy(x=900,y=400,speed_walk=4,speed_run=5,gravity=14,jump_power=30,frame_rate_ms=150,move_rate_ms=50,jump_height=140,p_scale=0.24,interval_time_jump=300))
        ...
        self.enemy_list.append (Enemy(x=550,y=100,speed_walk=4,speed_run=5,gravity=14,jump_power=30,frame_rate_ms=150,move_rate_ms=50,jump_height=140,p_scale=0.24,interval_time_jump=300))
        ...
        for coordenada in self.datos_obtenidos["tercer_nivel"]["plataformas"]:
            ...
            self.plataform_list.append(Plataform(x,y,width,height,type, path_img="images/tileset/plataforma3.png"))

            gema = Objeto(x=x, y=y-80, width=30, height=30, image_path="images/objetos/gema3.png", nombre="gema")
            self.objeto_list.append(gema)
            
        for coordenada in self.datos_obtenidos["tercer_nivel"]["salud"]:
        ...
        for objeto in self.objeto_list:
            if self.player.rect.colliderect(objeto.rect):
                if objeto.nombre == "gema":
                    ...
                    modificar_banderas("nivel_3", "terminado", True)
