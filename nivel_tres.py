...
class Level3():
    def __init__(self,w,h):
        ...
        self.static_background = Background(x=0,y=0,width=w,height=h,path="images/locations/set_bg_01/forest/all3.png")

        self.player_1 = Player(x=100,y=200,speed_walk=6,speed_run=12,gravity=14,jump_power=30,frame_rate_ms=100,move_rate_ms=50,jump_height=140,p_scale=0.2,interval_time_jump=300)
        ...
        # self.enemy_list.append (Enemy(x=1400,y=400,speed_walk=6,speed_run=5,gravity=14,jump_power=30,frame_rate_ms=150,move_rate_ms=50,jump_height=140,p_scale=0.08,interval_time_jump=300))
    ...
    def draw(self, pantalla): 
        ...
        if leer_bandera("nivel_3", "terminado"):
                print("Gano")
